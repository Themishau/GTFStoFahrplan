...
"}")
        ...
        self.label_title.setStyleSheet(u"color: #ee9462;")
        ...
        self.label_description.setStyleSheet(u"color: #ee9462;")
...
"}")
        ...
        self.label_loading.setStyleSheet(u"color: #ee9462;")
        ...
        self.label_credits.setStyleSheet(u"color: #ee9462;")
